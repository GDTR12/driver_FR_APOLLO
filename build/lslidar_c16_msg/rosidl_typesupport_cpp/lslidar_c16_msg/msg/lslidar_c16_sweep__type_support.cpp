...
static const _LslidarC16Sweep_type_support_symbol_names_t _LslidarC16Sweep_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, lslidar_c16_msg, msg, LslidarC16Sweep)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, lslidar_c16_msg, msg, LslidarC16Sweep)),
  }
};
...
{
  return &::lslidar_c16_msg::msg::rosidl_typesupport_cpp::LslidarC16Sweep_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, lslidar_c16_msg, msg, LslidarC16Sweep)() {
  return get_message_type_support_handle<lslidar_c16_msg::msg::LslidarC16Sweep>();
}
