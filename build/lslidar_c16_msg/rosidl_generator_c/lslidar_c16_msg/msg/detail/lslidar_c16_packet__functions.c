...
lslidar_c16_msg__msg__LslidarC16Packet__init(lslidar_c16_msg__msg__LslidarC16Packet * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    lslidar_c16_msg__msg__LslidarC16Packet__fini(msg);
    return false;
  }
  // data
  return true;
...
lslidar_c16_msg__msg__LslidarC16Packet__create()
{
  ...
  lslidar_c16_msg__msg__LslidarC16Packet * msg = (lslidar_c16_msg__msg__LslidarC16Packet *)allocator.allocate(sizeof(lslidar_c16_msg__msg__LslidarC16Packet), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(lslidar_c16_msg__msg__LslidarC16Packet));
  bool success = lslidar_c16_msg__msg__LslidarC16Packet__init(msg);
  if (!success) {
...
lslidar_c16_msg__msg__LslidarC16Packet__Sequence__init(lslidar_c16_msg__msg__LslidarC16Packet__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_c16_msg__msg__LslidarC16Packet * data = NULL;

  if (size) {
    data = (lslidar_c16_msg__msg__LslidarC16Packet *)allocator.zero_allocate(size, sizeof(lslidar_c16_msg__msg__LslidarC16Packet), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = lslidar_c16_msg__msg__LslidarC16Packet__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        lslidar_c16_msg__msg__LslidarC16Packet__fini(&data[i - 1]);
      }
...
lslidar_c16_msg__msg__LslidarC16Packet__Sequence__fini(lslidar_c16_msg__msg__LslidarC16Packet__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      lslidar_c16_msg__msg__LslidarC16Packet__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  lslidar_c16_msg__msg__LslidarC16Packet__Sequence * array = (lslidar_c16_msg__msg__LslidarC16Packet__Sequence *)allocator.allocate(sizeof(lslidar_c16_msg__msg__LslidarC16Packet__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = lslidar_c16_msg__msg__LslidarC16Packet__Sequence__init(array, size);
  if (!success) {
...
lslidar_c16_msg__msg__LslidarC16Packet__Sequence__destroy(lslidar_c16_msg__msg__LslidarC16Packet__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    lslidar_c16_msg__msg__LslidarC16Packet__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
lslidar_c16_msg__msg__LslidarC16Packet__Sequence__are_equal(const lslidar_c16_msg__msg__LslidarC16Packet__Sequence * lhs, const lslidar_c16_msg__msg__LslidarC16Packet__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!lslidar_c16_msg__msg__LslidarC16Packet__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  lslidar_c16_msg__msg__LslidarC16Packet__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(lslidar_c16_msg__msg__LslidarC16Packet);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    lslidar_c16_msg__msg__LslidarC16Packet * data =
      (lslidar_c16_msg__msg__LslidarC16Packet *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!lslidar_c16_msg__msg__LslidarC16Packet__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          lslidar_c16_msg__msg__LslidarC16Packet__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!lslidar_c16_msg__msg__LslidarC16Packet__copy(
