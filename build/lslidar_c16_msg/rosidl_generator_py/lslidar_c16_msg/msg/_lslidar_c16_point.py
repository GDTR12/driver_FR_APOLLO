...
class Metaclass_LslidarC16Point(type):
    """Metaclass of message 'LslidarC16Point'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__lslidar_c16_point
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__lslidar_c16_point
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__lslidar_c16_point
            cls._TYPE_SUPPORT = module.type_support_msg__msg__lslidar_c16_point
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__lslidar_c16_point
...
class LslidarC16Point(metaclass=Metaclass_LslidarC16Point):
    """Message class 'LslidarC16Point'."""
