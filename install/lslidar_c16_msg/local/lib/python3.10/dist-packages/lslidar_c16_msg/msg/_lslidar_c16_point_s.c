...
bool lslidar_c16_msg__msg__lslidar_c16_point__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("lslidar_c16_msg.msg._lslidar_c16_point.LslidarC16Point", full_classname_dest, 54) == 0);
  }
  lslidar_c16_msg__msg__LslidarC16Point * ros_message = _ros_message;
  {  // time
...
{
  /* NOTE(esteve): Call constructor of LslidarC16Point */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("lslidar_c16_msg.msg._lslidar_c16_point");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LslidarC16Point");
