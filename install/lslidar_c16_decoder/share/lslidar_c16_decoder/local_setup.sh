...
: ${AMENT_CURRENT_PREFIX:="/root/slam/slam/driver_FR_APOLLO/install/lslidar_c16_decoder"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lslidar_c16_decoder/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/lslidar_c16_decoder/environment/path.sh"
