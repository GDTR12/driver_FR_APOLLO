 ...
 */
    ...
    public:
        ...
        virtual int getPacket(lslidar_c16_msg::msg::LslidarC16Packet *pkt, const double time_offset) = 0;
...
/** @brief Live lslidar input from socket. */
    ...
    public:
        ...
        InputSocket(rclcpp::Node::SharedPtr private_nh, uint16_t port = MSOP_DATA_PORT_NUMBER);

        virtual ~InputSocket();

        virtual int getPacket(lslidar_c16_msg::msg::LslidarC16Packet *pkt, const double time_offset);
...
/** @brief lslidar input from PCAP dump file.
   ...
   */
    ...
    public:
        ...
        InputPCAP(rclcpp::Node::SharedPtr private_nh, uint16_t port = MSOP_DATA_PORT_NUMBER, double packet_rate = 0.0,
                  std::string filename = "", bool read_once = false, bool read_fast = false, double repeat_delay = 0.0);
